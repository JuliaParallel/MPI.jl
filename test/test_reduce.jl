...
ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 0")
...
ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 1")
using DoubleFloats

ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 2")
MPI.Init()

ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 3")
comm = MPI.COMM_WORLD
...
ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 9")
if can_do_closures
...
ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 10")
for T = [Int]
    ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 11 T")
    for dims = [1, 2, 3]
        ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 12 dims")
        send_arr = ArrayType(zeros(T, Tuple(3 for i in 1:dims)))
        send_arr[:] .= 1:length(send_arr)

        for op in operators
            ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 13 op")
            ...
            ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 14")
            ...
            ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 15")
            # IN_PLACE
            ...
            ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 16")
            # Allocating version
            ...
            ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 17")
            ...
            ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 18")
            # Allocating, Subarray
            ...
            ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 19")
        end
    end
end

#TODO ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 20
#TODO MPI.Barrier( MPI.COMM_WORLD )
#TODO ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 21
#TODO 
#TODO if can_do_closures
#TODO     ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 22
#TODO     send_arr = [Double64(i)/10 for i = 1:10]
#TODO 
#TODO     ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 23
#TODO     result = MPI.Reduce(send_arr, +, MPI.COMM_WORLD; root=root)
#TODO     ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 24
#TODO     if rank == root
...
#TODO     end
#TODO 
#TODO     ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 25
#TODO     MPI.Barrier( MPI.COMM_WORLD )
#TODO     ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 26
#TODO end

ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 27")
#TODO GC.gc()
ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 28")
MPI.Finalize()
ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 29")
@test MPI.Finalized()
ccall(:puts, Cint, (Ptr{Cchar},), "test_reduce 20")
