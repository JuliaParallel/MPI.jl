...
function init_openmpi_constants()
    ...
    global MPI_TYPE_NULL_COPY_FN = cglobal((:_OMPI_C_MPI_TYPE_NULL_COPY_FN, libmpi))
    global MPI_TYPE_NULL_DELETE_FN = cglobal((:_OMPI_C_MPI_TYPE_NULL_DELETE_FN, libmpi))
end
