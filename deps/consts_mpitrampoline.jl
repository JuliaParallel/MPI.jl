...
const MPI_MAX_PORT_NAME = 1024
const MPI_MAX_PROCESSOR_NAME = 256
...
# A value to initialize undefined Status values. Note that this is not
# the "empty status" described in the MPI standard (see e.g. MPI 3.1,
# section 3.7.3).
