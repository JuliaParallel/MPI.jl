...
@const_ref MPI_COMM_NULL  MPI_Comm Libdl.dlsym(libmpi_handle[], :ompi_mpi_comm_null)
@const_ref MPI_COMM_SELF  MPI_Comm Libdl.dlsym(libmpi_handle[], :ompi_mpi_comm_self)
@const_ref MPI_COMM_WORLD MPI_Comm Libdl.dlsym(libmpi_handle[], :ompi_mpi_comm_world)

@const_ref MPI_COMM_DUP_FN           MPI_Comm_copy_attr_function   Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_COMM_DUP_FN)
@const_ref MPI_COMM_NULL_COPY_FN     MPI_Comm_copy_attr_function   Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_COMM_NULL_COPY_FN)
@const_ref MPI_COMM_NULL_DELETE_FN   MPI_Comm_delete_attr_function Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_COMM_NULL_DELETE_FN)

@const_ref MPI_DATATYPE_NULL MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_datatype_null)

@const_ref MPI_BYTE MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_byte)
@const_ref MPI_PACKED MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_packed)
@const_ref MPI_CHAR MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_char)
@const_ref MPI_SHORT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_short)
@const_ref MPI_INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_int)
@const_ref MPI_LONG MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_long)
@const_ref MPI_FLOAT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_float)
@const_ref MPI_DOUBLE MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_double)
# @const_ref MPI_LONG_DOUBLE MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_long_double)
@const_ref MPI_UNSIGNED_CHAR MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_unsigned_char)
@const_ref MPI_SIGNED_CHAR MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_signed_char)
@const_ref MPI_UNSIGNED_SHORT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_unsigned_short)
@const_ref MPI_UNSIGNED_LONG MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_unsigned_long)
@const_ref MPI_UNSIGNED MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_unsigned)
@const_ref MPI_FLOAT_INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_float_int)
@const_ref MPI_DOUBLE_INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_double_int)
@const_ref MPI_LONG_DOUBLE_INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_longdbl_int)
@const_ref MPI_LONG_INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_long_int)
@const_ref MPI_SHORT_INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_short_int)
@const_ref MPI_2INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_2int)
@const_ref MPI_UB MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_ub)
@const_ref MPI_LB MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_lb)
@const_ref MPI_WCHAR MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_wchar)
@const_ref MPI_LONG_LONG_INT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_long_long_int)
const MPI_LONG_LONG = MPI_LONG_LONG_INT
@const_ref MPI_UNSIGNED_LONG_LONG MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_unsigned_long_long)
@const_ref MPI_2COMPLEX MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_2cplex)
@const_ref MPI_2DOUBLE_COMPLEX MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_2dblcplex)

@const_ref MPI_INT8_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_int8_t)
@const_ref MPI_UINT8_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_uint8_t)
@const_ref MPI_INT16_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_int16_t)
@const_ref MPI_UINT16_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_uint16_t)
@const_ref MPI_INT32_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_int32_t)
@const_ref MPI_UINT32_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_uint32_t)
@const_ref MPI_INT64_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_int64_t)
@const_ref MPI_UINT64_T MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_uint64_t)
@const_ref MPI_AINT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_aint)
@const_ref MPI_OFFSET MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_offset)
@const_ref MPI_C_BOOL MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_c_bool)
@const_ref MPI_C_FLOAT_COMPLEX MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_c_float_complex)
const MPI_C_COMPLEX = MPI_C_FLOAT_COMPLEX
@const_ref MPI_C_DOUBLE_COMPLEX MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_c_double_complex)
# @const_ref MPI_C_LONG_DOUBLE_COMPLEX MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_c_long_double_complex)
@const_ref MPI_COUNT MPI_Datatype Libdl.dlsym(libmpi_handle[], :ompi_mpi_count)


@const_ref MPI_ERRHANDLER_NULL MPI_Errhandler  Libdl.dlsym(libmpi_handle[], :ompi_mpi_errhandler_null)
@const_ref MPI_ERRORS_ARE_FATAL MPI_Errhandler Libdl.dlsym(libmpi_handle[], :ompi_mpi_errors_are_fatal)
@const_ref MPI_ERRORS_RETURN MPI_Errhandler    Libdl.dlsym(libmpi_handle[], :ompi_mpi_errors_return)
# @const_ref MPI_ERRORS_ABORT MPI_Errhandler     Libdl.dlsym(libmpi_handle[], :ompi_mpi_errors_abort)

@const_ref MPI_FILE_NULL MPI_File Libdl.dlsym(libmpi_handle[], :ompi_mpi_file_null)

@const_ref MPI_GROUP_EMPTY MPI_Group Libdl.dlsym(libmpi_handle[], :ompi_mpi_group_empty)
@const_ref MPI_GROUP_NULL MPI_Group Libdl.dlsym(libmpi_handle[], :ompi_mpi_group_null)

@const_ref MPI_INFO_ENV MPI_Info Libdl.dlsym(libmpi_handle[], :ompi_mpi_info_env)
@const_ref MPI_INFO_NULL MPI_Info Libdl.dlsym(libmpi_handle[], :ompi_mpi_info_null)

@const_ref MPI_MESSAGE_NO_PROC MPI_Message Libdl.dlsym(libmpi_handle[], :ompi_message_no_proc)
@const_ref MPI_MESSAGE_NULL MPI_Message Libdl.dlsym(libmpi_handle[], :ompi_message_null)

@const_ref MPI_DISPLACEMENT_CURRENT MPI_Offset -54278278

@const_ref MPI_OP_NULL MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_null)
@const_ref MPI_MAX     MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_max)
@const_ref MPI_MIN     MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_min)
@const_ref MPI_SUM     MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_sum)
@const_ref MPI_PROD    MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_prod)
@const_ref MPI_LAND    MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_land)
@const_ref MPI_BAND    MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_band)
@const_ref MPI_LOR     MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_lor)
@const_ref MPI_BOR     MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_bor)
@const_ref MPI_LXOR    MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_lxor)
@const_ref MPI_BXOR    MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_bxor)
@const_ref MPI_MINLOC  MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_minloc)
@const_ref MPI_MAXLOC  MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_maxloc)
@const_ref MPI_REPLACE MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_replace)
@const_ref MPI_NO_OP   MPI_Op Libdl.dlsym(libmpi_handle[], :ompi_mpi_op_no_op)

@const_ref MPI_REQUEST_NULL MPI_Request Libdl.dlsym(libmpi_handle[], :ompi_request_null)

@const_ref MPI_STATUS_IGNORE    Ptr{MPI_Status} C_NULL
@const_ref MPI_STATUSES_IGNORE  Ptr{MPI_Status} C_NULL

@const_ref MPI_TYPE_DUP_FN          MPI_Comm_copy_attr_function   reinterpret(Ptr{MPI_Comm_copy_attr_function}, Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_TYPE_DUP_FN))
@const_ref MPI_TYPE_NULL_COPY_FN    MPI_Type_copy_attr_function   reinterpret(Ptr{MPI_Comm_copy_attr_function}, Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_TYPE_NULL_COPY_FN))
@const_ref MPI_TYPE_NULL_DELETE_FN  MPI_Type_delete_attr_function reinterpret(Ptr{MPI_Type_delete_attr_function}, Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_TYPE_NULL_DELETE_FN))

@const_ref MPI_WIN_NULL MPI_Win Libdl.dlsym(libmpi_handle[], :ompi_mpi_win_null)

@const_ref MPI_WIN_DUP_FN           MPI_Win_copy_attr_function   reinterpret(Ptr{MPI_Win_copy_attr_function}, Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_WIN_DUP_FN))
@const_ref MPI_WIN_NULL_COPY_FN     MPI_Win_copy_attr_function   reinterpret(Ptr{MPI_Win_copy_attr_function}, Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_WIN_NULL_COPY_FN))
@const_ref MPI_WIN_NULL_DELETE_FN   MPI_Win_delete_attr_function reinterpret(Ptr{MPI_Win_delete_attr_function}, Libdl.dlsym(libmpi_handle[], :OMPI_C_MPI_WIN_NULL_DELETE_FN))
