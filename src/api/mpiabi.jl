...
const MPI_ABI_VERSION    = 1
const MPI_ABI_SUBVERSION = 0
...
@const_ref MPI_ERR_RMA_ATTACH             Cint 46
@const_ref MPI_ERR_RMA_CONFLICT           Cint 47
@const_ref MPI_ERR_RMA_RANGE              Cint 48
@const_ref MPI_ERR_RMA_SHARED             Cint 49
@const_ref MPI_ERR_RMA_SYNC               Cint 50
@const_ref MPI_ERR_SERVICE                Cint 51
@const_ref MPI_ERR_SIZE                   Cint 52
@const_ref MPI_ERR_SPAWN                  Cint 53
@const_ref MPI_ERR_UNSUPPORTED_DATAREP    Cint 54
@const_ref MPI_ERR_UNSUPPORTED_OPERATION  Cint 55
@const_ref MPI_ERR_WIN                    Cint 56
@const_ref MPI_ERR_RMA_FLAVOR             Cint 57
@const_ref MPI_ERR_PROC_ABORTED           Cint 58
@const_ref MPI_ERR_VALUE_TOO_LARGE        Cint 59
@const_ref MPI_ERR_SESSION                Cint 60
@const_ref MPI_ERR_ERRHANDLER             Cint 61
@const_ref MPI_ERR_ABI                    Cint 62

@const_ref MPI_T_ERR_CANNOT_INIT          Cint 1001
@const_ref MPI_T_ERR_NOT_ACCESSIBLE       Cint 1002
@const_ref MPI_T_ERR_NOT_INITIALIZED      Cint 1003
@const_ref MPI_T_ERR_NOT_SUPPORTED        Cint 1004
@const_ref MPI_T_ERR_MEMORY               Cint 1005
@const_ref MPI_T_ERR_INVALID              Cint 1006
@const_ref MPI_T_ERR_INVALID_INDEX        Cint 1007
@const_ref MPI_T_ERR_INVALID_ITEM         Cint 1008
@const_ref MPI_T_ERR_INVALID_SESSION      Cint 1009
@const_ref MPI_T_ERR_INVALID_HANDLE       Cint 1010
@const_ref MPI_T_ERR_INVALID_NAME         Cint 1011
@const_ref MPI_T_ERR_OUT_OF_HANDLES       Cint 1012
@const_ref MPI_T_ERR_OUT_OF_SESSIONS      Cint 1013
@const_ref MPI_T_ERR_CVAR_SET_NOT_NOW     Cint 1014
@const_ref MPI_T_ERR_CVAR_SET_NEVER       Cint 1015
@const_ref MPI_T_ERR_PVAR_NO_WRITE        Cint 1016
@const_ref MPI_T_ERR_PVAR_NO_STARTSTOP    Cint 1017
@const_ref MPI_T_ERR_PVAR_NO_ATOMIC       Cint 1018
...
@const_ref MPI_UNWEIGHTED                 Ptr{Cint} 10
...
@const_ref MPI_ANY_TAG                    Cint -2
# Rank sentinels - must be negative
@const_ref MPI_PROC_NULL                  Cint -3
...
@const_ref MPI_THREAD_FUNNELED            Cint 1024
@const_ref MPI_THREAD_SERIALIZED          Cint 2048
@const_ref MPI_THREAD_MULTIPLE            Cint 4096

# Array Datatype Order
@const_ref MPI_ORDER_C                    Cint 0xC
@const_ref MPI_ORDER_FORTRAN              Cint 0xF
...
@const_ref MPI_COMBINER_NAMED             Cint 101
@const_ref MPI_COMBINER_DUP               Cint 102
@const_ref MPI_COMBINER_CONTIGUOUS        Cint 103
@const_ref MPI_COMBINER_VECTOR            Cint 104
@const_ref MPI_COMBINER_HVECTOR           Cint 105
@const_ref MPI_COMBINER_INDEXED           Cint 106
@const_ref MPI_COMBINER_HINDEXED          Cint 107
@const_ref MPI_COMBINER_INDEXED_BLOCK     Cint 108
@const_ref MPI_COMBINER_HINDEXED_BLOCK    Cint 109
@const_ref MPI_COMBINER_STRUCT            Cint 110
@const_ref MPI_COMBINER_SUBARRAY          Cint 111
@const_ref MPI_COMBINER_DARRAY            Cint 112
@const_ref MPI_COMBINER_F90_REAL          Cint 113
@const_ref MPI_COMBINER_F90_COMPLEX       Cint 114
@const_ref MPI_COMBINER_F90_INTEGER       Cint 115
@const_ref MPI_COMBINER_RESIZED           Cint 116
@const_ref MPI_COMBINER_VALUE_INDEX       Cint 117

# Fortran Datatype Matching
@const_ref MPIX_TYPECLASS_LOGICAL         Cint 191
@const_ref MPI_TYPECLASS_INTEGER          Cint 192
@const_ref MPI_TYPECLASS_REAL             Cint 193
@const_ref MPI_TYPECLASS_COMPLEX          Cint 194

# Communicator and Group Comparisons
@const_ref MPI_IDENT                      Cint 201
@const_ref MPI_CONGRUENT                  Cint 202
@const_ref MPI_SIMILAR                    Cint 203
@const_ref MPI_UNEQUAL                    Cint 204

# Communicator Virtual Topology Types
@const_ref MPI_CART                       Cint 211
@const_ref MPI_GRAPH                      Cint 212
@const_ref MPI_DIST_GRAPH                 Cint 213

# Communicator Split Types
@const_ref MPI_COMM_TYPE_SHARED           Cint 221
@const_ref MPI_COMM_TYPE_HW_UNGUIDED      Cint 222
@const_ref MPI_COMM_TYPE_HW_GUIDED        Cint 223
@const_ref MPI_COMM_TYPE_RESOURCE_GUIDED  Cint 224

# Window Lock Types
@const_ref MPI_LOCK_EXCLUSIVE             Cint 301
@const_ref MPI_LOCK_SHARED                Cint 302

# Window Create Flavors
@const_ref MPI_WIN_FLAVOR_CREATE          Cint 311
@const_ref MPI_WIN_FLAVOR_ALLOCATE        Cint 312
@const_ref MPI_WIN_FLAVOR_DYNAMIC         Cint 313
@const_ref MPI_WIN_FLAVOR_SHARED          Cint 314

# Window Memory Models
@const_ref MPI_WIN_UNIFIED                Cint 321
@const_ref MPI_WIN_SEPARATE               Cint 322

# File Positioning
@const_ref MPI_SEEK_CUR                   Cint 401
@const_ref MPI_SEEK_END                   Cint 402
@const_ref MPI_SEEK_SET                   Cint 403

# File Operation Constants
@const_ref MPI_DISPLACEMENT_CURRENT       MPI_Offset -1
...
# Communicator
@const_ref MPI_TAG_UB                     Cint 501
@const_ref MPI_IO                         Cint 502
@const_ref MPI_HOST                       Cint 503
@const_ref MPI_WTIME_IS_GLOBAL            Cint 504
@const_ref MPI_APPNUM                     Cint 505
@const_ref MPI_LASTUSEDCODE               Cint 506
@const_ref MPI_UNIVERSE_SIZE              Cint 507

# Window
@const_ref MPI_WIN_BASE                   Cint 601
@const_ref MPI_WIN_DISP_UNIT              Cint 602
@const_ref MPI_WIN_SIZE                   Cint 603
@const_ref MPI_WIN_CREATE_FLAVOR          Cint 604
@const_ref MPI_WIN_MODEL                  Cint 605
