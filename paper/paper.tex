...
imposed by the MPI launchers make it difficult to run interactive sessions, and though has
some facility for dynamic process management, it does not work outside the launcher.
