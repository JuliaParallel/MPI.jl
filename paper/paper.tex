...
point-to-point (blocking and nonblocking), collective, and one-sided communication
operations as well as MPI I/O operations.
...
number types, MPI.jl will use the predefined MPI datatypes. For other types such as
user-defined structs MPI.jl, or if the buffer is a strided view, MPI.jl will build and
commit a corresponding MPI user-defined type. A lower-level, C-like interface for manually
constructing and committing MPI datatypes is also available.
